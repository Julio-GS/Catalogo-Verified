...
export default function Mac({ products }) {
  const Mac = products.filter((product) => product.Categoría === "Mac");
  ...
  const filters = [
    {
      name: "stock",
      label: "Stock",
      options: [...new Set(Mac.map((product) => product.Stock))],
    },

    {
      name: "capacity",
      label: "Capacidad",
      options: [...new Set(Mac.map((product) => product.Capacidad))],
    },
  ];

  useEffect(() => {
    setResults(Mac);
    setFilteredResults(Mac);
  }, [products]);
      ...
      <div className="flex flex-col lg:flex-row pt-20">
        ...
        <div className="w-full lg:w-3/4 p-4">
          ...
          <h2 className="text-2xl font-bold mb-6 text-left">
            Descubre todas nuestras Mac Studio y Mac Mini
          </h2>
