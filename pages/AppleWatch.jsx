...
export default function AppleWatch({ products }) {
  const Watch = products.filter(
    (product) => product.Categoría === "Apple Watch"
  );
  ...
  const filters = [
    {
      name: "stock",
      label: "Stock",
      options: [...new Set(Watch.map((product) => product.Stock))],
    },
  ];

  useEffect(() => {
    setResults(Watch);
    setFilteredResults(Watch);
  }, [products]);
      ...
      <div className="flex flex-col lg:flex-row pt-20">
        ...
        <div className="w-full lg:w-3/4 p-4">
          ...
          <h2 className="text-2xl font-bold mb-6 text-left">
            Descubre todos nuestros Apple Watch
          </h2>
