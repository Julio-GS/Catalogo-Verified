...
export default function MacBook({ products }) {
  const MacBook = products.filter((product) => product.Categoría === "MacBook");
  ...
  const filters = [
    {
      name: "stock",
      label: "Stock",
      options: [...new Set(MacBook.map((product) => product.Stock))],
    },

    {
      name: "capacity",
      label: "Capacidad",
      options: [...new Set(MacBook.map((product) => product.Capacidad))],
    },
  ];

  useEffect(() => {
    setResults(MacBook);
    setFilteredResults(MacBook);
  }, [products]);
      ...
      <div className="flex flex-col lg:flex-row pt-20">
        ...
        <div className="w-full lg:w-3/4 p-4">
          ...
          <h2 className="text-2xl font-bold mb-6 text-left">
            Descubre todas nuestras MacBook
          </h2>
